...
```{r}
raster_to_mapset(lus, as_integer = TRUE, overwrite = TRUE)
```
...
We can use the function `vibe_check()` if you need to print a list of all the data currently stored in the GRASS mapset:
